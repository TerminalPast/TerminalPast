            ...
            (t.exports = function (t) {
              function n(o) {
                if (o.isInitialValue()) {
                  ...
                  var t = s.create(
                      "span",
                      "tick-flip-shadow-top tick-flip-front"
                    ),
                    e = s.create(
                      "span",
      ...
      var n = (function () {
        ...
        function l(t) {
          return t.match(/(Z)|([+\-][0-9]{2}:?[0-9]*$)/g)
            ? new Date(t)
            : ((t += -1 !== t.indexOf("T") ? "Z" : ""), O(new Date(t)));
        }
        function g(r, t) {
            ...
            function (t, e) {
              ...
              return (
                /(?:mon|tues|wednes|thurs|fri|satur|sun)day/.test(e) &&
                  (t.day = x[(n = e).charAt(0).toUpperCase() + n.slice(1)]),
                /^at/.test(e)
                  ? (t.time = Pe(S(r), e.substr(3)))
              ...
              return function (t, e) {
                (t = parseFloat(t)),
                  null !== o
                    ? a
                      ? a.update(e, t)
                      : (a = xt("spring", n, r, i)).update(e, o, t)
                    : e((o = t));
              };
            },
            delay: function () {
